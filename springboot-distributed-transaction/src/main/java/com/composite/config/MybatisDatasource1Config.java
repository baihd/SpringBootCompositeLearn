...
@MapperScan(basePackages = "com.composite.dao1", sqlSessionFactoryRef = "sqlSessionFactory1")
public class MybatisDatasource1Config {
    ...
    public SqlSessionFactory sqlSessionFactory1() throws Exception {
        ...
        factoryBean.setMapperLocations(resolver.getResources("classpath:mapper1/*.xml"));
